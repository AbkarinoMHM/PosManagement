...
angular.module('posVendor').component('posVendorsList', {
    ...
    controller: function posTypeController($scope, $log, $mdBottomSheet, HttpService,
        ...
        var self = this;
        $scope.moduleName = 'Pos Vendor';
        self.moduleNamePlural = 'Pos Vendors'
        self.baseServiceUrl = 'services/posvendor';
        self.baseTemplateUrl = 'templates/posVendor';
        ...
        $scope.gridOptions = {
            ...
            columnDefs: [
                ...
                {name: 'name', displayName: "Pos Vendor Name", headerTooltip: "Filter Name: name"},
                {
