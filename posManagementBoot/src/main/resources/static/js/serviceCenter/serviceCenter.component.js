...
angular.module('serviceCenter').component('serviceCentersList', {
    ...
    controller: function projectController($scope, $log, $mdBottomSheet, HttpService,
        ...
        var self = this;
        self.moduleName = 'Service Center';
        self.baseServiceUrl = 'services/servicecenter';
        self.baseTemplateUrl = 'templates/serviceCenter';
        ...
        $scope.gridOptions = {
            ...
            columnDefs: [
                ...
                {name: 'name', displayName: "Service Center Name", headerTooltip: "Filter: name"},
                {name: 'address', displayName: "Service Center Address", headerTooltip: "Filter: address"},
                {name: 'tel', displayName: "Service Center Tel", headerTooltip: "Filter: tel"},
        ...
        function getPaginatedInfo(page, size) {
            ...
            HttpService.httpGet(self.baseServiceUrl + '/get?page=' + page + '&size=' + size + '&search=' + searchString).then(function (response) {
                ...
                if (response.status == 404) {//nothing found
                    ...
                    DialogService.toastrWarning("No Service Centers found!");
                } else {
